...
const About = () => {
  return (
    <div className="mx-14 mt-2 h-[90vh] relative">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-3 h-full">

        {/* Info Section */}
        <div>
          <h2 className="text-3xl font-semibold mt-6 text-center md:text-start font-semibold">About Me</h2>
        ...
        <div className='text-3xl font-semibold h-full'>
            <h2 className='md:m-5 m-0 md:text-start text-center font-semibold'>Education</h2>
            <div className='flex m-5 h-[80%] justify-between relative'>
                <p className='absolute md:block hidden text-[18px] rotate-90 origin-left left-[62px] top-[20px] p-1 bg-[#F8F8F8]'>2022</p>
                <p className='absolute md:block hidden text-[18px] rotate-90 origin-left left-[62px] top-[220px] p-1 bg-[#F8F8F8]'>2019</p>
                <p className='absolute md:block hidden text-[18px] rotate-90 origin-left left-[62px] bottom-[70px] p-1 bg-[#F8F8F8]'>2013</p>

                {/* Vertical Line */}
                <div className='border-2 border-black h-full ml-[60px] md:block hidden'></div>

                <div className='flex md:flex-col flex-row gap-[50px] justify-between'>
        ...
        {/* Experience Section */}
        <div className='text-3xl font-semibold h-full'>
            <h2 className='m-5 md:text-start text-center font-semibold'>Experience</h2>
            <div className='flex m-5 h-[80%] justify-between relative'>
                <p className='absolute md:block hidden text-[18px] rotate-90 origin-left left-[62px] p-1 bg-[#F8F8F8]'>Present</p>
                <p className='absolute md:block hidden text-[18px] rotate-90 origin-left left-[62px] top-[220px] p-1 bg-[#F8F8F8]'>2024</p>
                <p className='absolute md:block hidden text-[18px] rotate-90 origin-left left-[62px] bottom-[70px] p-1 bg-[#F8F8F8]'>2023</p>

                {/* Vertical Line */}
                <div className='border-2 border-black h-full ml-[60px] md:block hidden'></div>

                <div className='flex md:flex-col flex-row gap-[50px] md:justify-between'>
